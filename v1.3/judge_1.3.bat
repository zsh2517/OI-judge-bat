...
rem 初始化变量数目
	...
	set num_tle=0
rem 作者介绍 
	title  By.ZHSHH OI程序测试 Version 1.3 (Date 2018-09-20^)
	rem echo DEBUG %recomment%
	if %recomment% EQU 1 (
		echo By.ZHSHH OI程序测试 Version 1.3 (Date 2018-09-20^)
		echo.
...
:way1
	...
	set rune=%errorlevel%
	set b=%time%
	fc %name%.%output% %name%%number%.%answer%>fc
...
echo.
echo 上述出现优先级CE^>RE^>TLE^>WA^>AC (即介绍顺序)
echo 任意键退出
pause>nul
goto quit
REM :make_autockeck
...
ping -n 2 127.1>nul&echo.                                                                                                                     
ping -n 1 127.1>nul&echo             ,]@@@@@@@@@@@@]]@@@@.      \@@@@@^^                       =@@@@@^^             ,]@@@@@@@@@@@@]]@@@@^^      
ping -n 1 127.1>nul&echo          ]@@@@@@@@@@@@@@@@@@@@@@.      =@@@@@^^                       @@@@@@.          ,@@@@@@@@@@@@@@@@@@@@@@^^      
ping -n 1 127.1>nul&echo        /@@@@@@@@@[[[[[\@@@@@@@@@.       @@@@@\                       @@@@@@         ,@@@@@@@@@[[[[[[@@@@@@@@@^^      
ping -n 2 127.1>nul&echo      .@@@@@@@`            @@@@@@.       \@@@@@                      =@@@@@^^        /@@@@@@`            /@@@@@^^      
ping -n 1 127.1>nul&echo     .@@@@@@`              @@@@@@.       =@@@@@`       .OOOO`        =@@@@@^^       @@@@@@/              O@@@@@^^      
ping -n 1 127.1>nul&echo     @@@@@@^^               @@@@@@.       ,@@@@@^^       =@@@@@`       O@@@@@       /@@@@@^^               O@@@@@^^      
ping -n 1 127.1>nul&echo    =@@@@@/                @@@@@@.        @@@@@O      ,@@@@@@@       @@@@@^^      .@@@@@@                O@@@@@^^      
ping -n 2 127.1>nul&echo    \@@@@@^^                @@@@@@.        =@@@@@      @@@@@@@@^^     ,@@@@@^^      =@@@@@/                O@@@@@^^      
ping -n 1 127.1>nul&echo    @@@@@@^^                @@@@@@.        =@@@@@`    =@@@@\@@@@`    =@@@@@       =@@@@@^^                O@@@@@^^      
ping -n 1 127.1>nul&echo    @@@@@@^^                @@@@@@.        .@@@@@^^   ,@@@@^^,@@@@@    =@@@@/       =@@@@@^^                O@@@@@^^      
ping -n 1 127.1>nul&echo    @@@@@@^^                @@@@@@.         O@@@@\   @@@@@  \@@@@\   @@@@@^^       =@@@@@^^                O@@@@@^^      
ping -n 2 127.1>nul&echo    \@@@@@^^               ,@@@@@@.         =@@@@@  =@@@@`   @@@@@^^ .@@@@@.       =@@@@@@               ,@@@@@@^^      
ping -n 1 127.1>nul&echo    =@@@@@@`             /@@@@@@@.         ,@@@@@.,@@@@^^    ,@@@@@.=@@@@@        .@@@@@@^^             /@@@@@@@^^      
...
:quit
	REM 没什么、、
	REM BLOG：https://zsh2517.wordpress.com/2018/07/07，里面有指向blog的链接